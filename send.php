...
$tel = $_POST['form_fields']['tel'] ?? '';
$email = $_POST['form_fields']['email'] ?? '';
$company = $_POST['form_fields']['company'] ?? '';
$services = $_POST['form_fields']['services'] ?? '';
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
            ...
            <td style="padding:20px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;color:#333;">
                ...
                <tr>
                  ...
                  <td style="padding:8px 0;">' . htmlspecialchars($tel) . '</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:8px 0;">' . htmlspecialchars($services) . '</td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background:#f0f0f0;padding:15px;font-size:12px;color:#777;text-align:center;">
              This email was sent from celestial611722.com contact form.
            </td>
          </tr>
...
try {
    ...
    // 設定寄件者（網域的信箱）
    $mail->setFrom('service@celestial611722.com', 'celestial611722.com');
