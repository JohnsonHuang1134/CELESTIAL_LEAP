function Layzr(t) {
    this._lastScroll = 0, this._ticking = !1, t = t || {}, this._optionsContainer = document.querySelector(t.container) || window, this._optionsSelector = t.selector || "[data-layzr]", this._optionsAttr = t.attr || "data-layzr", this._optionsAttrSrcSet = t.attrSrcSet || "data-layzr-srcset", this._optionsAttrRetina = t.retinaAttr || "data-layzr-retina", this._optionsAttrBg = t.bgAttr || "data-layzr-bg", this._optionsAttrHidden = t.hiddenAttr || "data-layzr-hidden", this._optionsThreshold = t.threshold || 0, this._optionsBefore = t.before || null, this._optionsAfter = t.after || null, this._optionsCallback = t.callback || null, this._optionsIsloadedClass = t.isloadedClass || "is-loaded", this._optionsIsloadingClass = t.isloadingClass || "is-loading", this._optionsNodesFilterCallback = t.nodesFilter || null, this._retina = window.devicePixelRatio > 1, this._srcAttr = this._retina ? this._optionsAttrRetina : this._optionsAttr, this.updateSelector(), this._handlerBind = this._requestScroll.bind(this), this._create()
}
...
! function(t) {
    ...
    function() {
        ...
        var e = this._optionsSelector.replace(/\./g, ""),
            ...
            o = t;
        return "function" == typeof this._optionsNodesFilterCallback && (o = o.filter(this._optionsNodesFilterCallback)), o.filter((function(t) {
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(a, n);
            var r, l, d, c, h, u, p, f, m, g, v, w, y, b, C, _, x, S, k, T, I, L, z, E, O, P, A, D, M, F, H, B, R, W, j, $, N, G, Y, q, U, V, X, Z, Q, K, J, tt, et, it, nt, ot, st, at, rt, lt, dt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Lt = function(t, e, i, n, o) {
                    (!bt || o && o !== s.currItem) && (n /= o ? o.fitRatio : s.currItem.fitRatio), t[L] = w + e + "px, " + i + "px" + y + " scale(" + n + ")"
                },
                zt = function(t) {
                    et && (t && (g > s.currItem.fitRatio ? bt || (Ze(s.currItem, !1, !0), bt = !0) : bt && (Ze(s.currItem), bt = !1)), Lt(et, ht.x, ht.y, g))
                },
                Et = function(t) {
                ...
                jt = function(t, e, i, n) {
                    return n === s.currItem.initialZoomLevel ? (i[t] = s.currItem.initialPosition[t], !0) : (i[t] = At(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
                },
                $t = function(t) {
                    var e = "";
                ...
                Qt = {
                    ...
                    applyZoomPan: function(t, e, i, n) {
                        ht.x = e, ht.y = i, g = t, zt(n)
                    },
                    init: function() {
                        if (!r && !l) {
                            var i;
                            s.framework = o, s.template = t, s.bg = o.getChildByClass(t, "pswp__bg"), A = t.className, r = !0, H = o.detectFeatures(), O = H.raf, P = H.caf, L = H.transform, M = H.oldIE, s.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), s.container = o.getChildByClass(s.scrollWrap, "pswp__container"), h = s.container.style, s.itemHolders = _ = [{
                                ...
                                function() {
                                    ...
                                    L = "left", o.addClass(t, "pswp--ie"), Ot = function(t, e) {
                                        e.left = t + "px"
                                    }, Et = function(t) {
                            ...
                            kt("firstUpdate"), c = c || a.index || 0, (isNaN(c) || c < 0 || c >= je()) && (c = 0), s.currItem = We(c), (H.isOldIOSPhone || H.isOldAndroid) && (vt = !1), t.setAttribute("aria-hidden", "false"), a.modal && (vt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (kt("initialLayout"), F = D = o.getScrollY());
                            var d = "pswp--open ";
                            for (a.mainClass && (d += a.mainClass + " "), a.showHideOpacity && (d += "pswp--animate_opacity "), d += E ? "pswp--touch" : "pswp--notouch", d += H.animationName ? " pswp--css_animation" : "", d += H.svg ? " pswp--svg" : "", o.addClass(t, d), s.updateSize(), u = -1, gt = null, i = 0; i < 3; i++) Ot((i + u) * mt.x, _[i].el.style);
                            M || o.bind(s.scrollWrap, f, s), St("initialZoomInEnd", (function() {
                                s.setContent(_[0], c - 1), s.setContent(_[2], c + 1), _[0].el.style.display = _[2].el.style.display = "block", a.focus && t.focus(), o.bind(document, "keydown", s), H.transform && o.bind(s.scrollWrap, "click", s), a.mouseUsed || o.bind(document, "mousemove", Ht), o.bind(window, "resize scroll orientationchange", s), kt("bindEvents")
                            })), s.setContent(_[1], c), s.updateCurrItem(), kt("afterInit"), vt || (b = setInterval((function() {
                    ...
                    destroy: function() {
                        kt("destroy"), Fe && clearTimeout(Fe), t.setAttribute("aria-hidden", "true"), t.className = A, b && clearInterval(b), o.unbind(s.scrollWrap, f, s), o.unbind(window, "scroll", s), fe(), Xt(), xt = null
                    },
                    panTo: function(t, e, i) {
                        i || (t > tt.min.x ? t = tt.min.x : t < tt.max.x && (t = tt.max.x), e > tt.min.y ? e = tt.min.y : e < tt.max.y && (e = tt.max.y)), ht.x = t, ht.y = e, zt()
                    },
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== gt) {
                            ...
                            if (!(t && i < 2)) {
                                ...
                                for (var n = 0; n < i; n++) gt > 0 ? (e = _.shift(), _[2] = e, u++, Ot((u + 2) * mt.x, e.el.style), s.setContent(e, c - i + n + 1 + 1)) : (e = _.pop(), _.unshift(e), u--, Ot(u * mt.x, e.el.style), s.setContent(e, c + i - n - 1 - 1));
                                if (et && 1 === Math.abs(gt)) {
                                    var o = We(x);
                                    o.initialZoomLevel !== g && (qe(o, ut), Ze(o), Et(o))
                                }
                                gt = 0, s.updateCurrZoomItem(), x = c, kt("afterChange")
                            }
                        }
                    },
                    updateSize: function(e) {
                        ...
                        if (ut.x = s.scrollWrap.clientWidth, ut.y = s.scrollWrap.clientHeight, Gt(), mt.x = ut.x + Math.round(ut.x * a.spacing), mt.y = ut.y, Pt(mt.x * pt), kt("beforeResize"), void 0 !== u) {
                            for (var n, r, l, d = 0; d < 3; d++) n = _[d], Ot((d + u) * mt.x, n.el.style), l = c + d - 1, a.loop && je() > 2 && (l = _t(l)), (r = We(l)) && (C || r.needsUpdate || !r.bounds) ? (s.cleanSlide(r), s.setContent(n, l), 1 === d && (s.currItem = r, s.updateCurrZoomItem(!0)), r.needsUpdate = !1) : -1 === n.index && l >= 0 && s.setContent(n, l), r && r.container && (qe(r, ut), Ze(r), Et(r));
                            C = !1
                        }
                        v = g = s.currItem.initialZoomLevel, (tt = s.currItem.bounds) && (ht.x = tt.center.x, ht.y = tt.center.y, zt(!0)), kt("resize")
                    },
                    zoomTo: function(t, e, i, n, s) {
                        ...
                        Mt(r);
                        var h = function(e) {
                            1 === e ? (g = t, ht.x = r.x, ht.y = r.y) : (g = (t - l) * e + l, ht.x = (r.x - d) * e + d, ht.y = (r.y - c) * e + c), s && s(e), zt(1 === e)
                        };
                ...
                ke = function(t) {
                    ...
                    return z ? (lt = 0, ne.forEach((function(t) {
                        0 === lt ? Se[0] = t : 1 === lt && (Se[1] = t), lt++
                    }))) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Se[0] = ye(t.touches[0], _e), t.touches.length > 1 && (Se[1] = ye(t.touches[1], xe))) : (_e.x = t.pageX, _e.y = t.pageY, _e.id = "", Se[0] = _e), Se
                },
                Te = function(t, e) {
                ...
                Ie = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!G || "mousedown" !== t.type) {
                            if (we(t, !0) && t.preventDefault(), kt("pointerDown"), z) {
                            ...
                            var i = ke(t),
                                n = i.length;
                            Q = null, Xt(), Y && 1 !== n || (Y = ot = !0, o.bind(window, p, s), $ = rt = st = N = Z = V = q = U = !1, nt = null, kt("firstTouchStart", i), Dt(ct, ht), dt.x = dt.y = 0, Dt(ee, i[0]), Dt(ie, ee), oe.x = mt.x * pt, se = [{
                                x: ee.x,
                                y: ee.y
                            }], W = R = Tt(), Bt(g, !0), fe(), me()), !K && n > 1 && !it && !Z && (v = g, U = !1, K = q = !0, dt.y = dt.x = 0, Dt(ct, ht), Dt(Kt, i[0]), Dt(Jt, i[1]), be(Kt, Jt, ue), he.x = Math.abs(ue.x) - ht.x, he.y = Math.abs(ue.y) - ht.y, J = pe(Kt, Jt))
                        }
                    }
                },
                Le = function(t) {
                    ...
                    if (Q) {
                        ...
                        if (0 !== t)
                            if (Dt(Kt, Q[0]), te.x = Kt.x - ee.x, te.y = Kt.y - ee.y, K && t > 1) {
                                ...
                                n < 0 && (n = 0), be(Kt, Jt, le), dt.x += le.x - ue.x, dt.y += le.y - ue.y, Dt(ue, le), ht.x = At("x", i), ht.y = At("y", i), $ = i > g, g = i, zt()
                            } else {
                                if (!nt) return;
                                ...
                                if ("v" === nt && a.closeOnVerticalDrag && "fit" === a.scaleMode && g === s.currItem.initialZoomLevel) {
                                    dt.y += te.y, ht.y += te.y;
                                    var d = Ce();
                                    return N = !0, kt("onVerticalDrag", d), It(d), void zt()
                                }(function(t, e, i) {
                                    if (t - W > 50) {
                                        var n = se.length > 2 ? se.shift() : {};
                                        n.x = e, n.y = i, se.push(n), W = t
                                    }
                                })(Tt(), Kt.x, Kt.y), V = !0, tt = s.currItem.bounds, Te("x", te) || (Te("y", te), Mt(ht), zt())
                            }
                    }
                },
                Ee = function(t) {
                    ...
                    var e;
                    if (kt("pointerUp"), we(t, !1) && t.preventDefault(), z) {
                    ...
                    1 === l && Dt(ie, r[0]), 0 !== l || nt || it || (e || ("mouseup" === t.type ? e = {
                        x: t.pageX,
                        y: t.pageY,
                        type: "mouse"
                        ...
                        if (Xt(), j || (j = Oe()), j.calculateSwipeSpeed("x"), N) {
                            if (Ce() < a.verticalDragRange) s.close();
                                ...
                                Zt("verticalDrag", 0, 1, 300, o.easing.cubic.out, (function(t) {
                                    ht.y = (s.currItem.initialPosition.y - c) * t + c, It((1 - h) * t + h), zt()
                                })), kt("onVerticalDrag", 1)
                            }
                        } else {
                            if ((Z || it) && 0 === l) {
                ...
                Oe = function() {
                    var t, e, i = {
                        ...
                        panAnimLoop: function() {
                            if (Yt.zoomPan && (Yt.zoomPan.raf = O(i.panAnimLoop), i.now = Tt(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), zt(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05)) return ht.x = Math.round(ht.x), ht.y = Math.round(ht.y), zt(), void Ut("zoomPan")
                        }
                    };
                    return i
                },
            ...
            Ct("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        ...
                        (z = H.pointerEvent) && H.touch && (H.touch = !1), z ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : H.touch ? (t("touch", "start", "move", "end", "cancel"), E = !0) : t("mouse", "down", "move", "up"), p = k + " " + T + " " + I, f = S, z && !E && (E = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), s.likelyTouchDevice = E, m[S] = Ie, m[k] = Le, m[T] = Ee, I && (m[I] = m[T]), H.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[k], m.mouseup = m[T]), E || (a.allowPanToNext = !1)
                    }
                }
            });
            var Fe, He, Be, Re, We, je, $e = function(e, i, n, r) {
                    ...
                    if (!h || !l || void 0 === l.x) return kt("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Dt(ht, e.initialPosition), zt(), t.style.opacity = n ? 0 : 1, It(1), void(h ? setTimeout((function() {
                        u()
                    }), h) : u());
                    ! function() {
                        var i = d,
                            r = !s.currItem.src || s.currItem.loadError || a.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ht.x = l.x, ht.y = l.y - D, s[r ? "template" : "bg"].style.opacity = .001, zt()), Vt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), r && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout((function() {
                            ...
                            if (kt("initialZoom" + (n ? "Out" : "In")), n) {
                                var s = l.w / e.w,
                                    ...
                                    c = at,
                                    p = function(e) {
                                        1 === e ? (g = s, ht.x = l.x, ht.y = l.y - F) : (g = (s - d) * e + d, ht.x = (l.x - a.x) * e + a.x, ht.y = (l.y - F - a.y) * e + a.y), zt(), r ? t.style.opacity = 1 - e : It(c - e * c)
                                    };
                                i ? Zt("initialZoom", 0, 1, h, o.easing.cubic.out, p, u) : (p(1), Fe = setTimeout(u, h + 20))
                            } else g = e.initialZoomLevel, Dt(ht, e.initialPosition), zt(), It(1), r ? t.style.opacity = 1 : It(1), Fe = setTimeout(u, h + 20)
                        }), n ? 25 : 90)
                    }()
                },
                Ne = {},
            ...
            Ct("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function(t, e) {
                        if (e && !V && !q && !qt) {
                            ...
                            Dt(ti, i), Ke = setTimeout((function() {
                                ei(t, e), Ke = null
                            }), 300)
                        }
                    }
                ...
                publicMethods: {
                    ...
                    handleMouseWheel: function(t) {
                        if (g <= s.currItem.fitRatio) return a.modal && (!a.closeOnScroll || qt || Y ? t.preventDefault() : L && Math.abs(t.deltaY) > 2 && (d = !0, s.close())), !0;
            ...
            b.init = function() {
                e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), h = t.listen,
                    function() {
                        ...
                        x || E(), w && clearInterval(w), e.unbind(document, "mouseout", F), e.unbind(document, "mousemove", M), e.unbind(n, "pswpTap click", k), e.unbind(t.scrollWrap, "pswpTap", b.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", b.onMouseOver), i && (e.unbind(document, i.eventK, b.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
                    })), h("destroy", (function() {
                    ...
                    function() {
                        ...
                        a && s(a.children)
                    }(), g.shareEl && r && l && (x = !0), L(), g.timeToIdle && h("mouseUsed", (function() {
                ...
                _ && t.currItem ? (b.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), I(o, "caption--empty", !t.currItem.title)), C = !0) : C = !1, x || E(), L()
    ...
    function(t, e, i) {
        ...
        t.fn.Filterade = function(e) {
            var i, o, s, a, r, l, d, c, h, u, p, f, m, g, v, w, y, b, C, _, x, S, k, T, I = !1;
            l = {
                useFilters: !1,
                useSorting: !1,
                ...
                activeClass: "act",
                log: !1
            }, r = t(this), k = e.customSorters || {}, w = e.paginationMode || l.paginationMode, y = t(e.pageControls || l.pageControls), d = t(e.filterControls || l.filterControls), c = t(e.sortControls || l.sortControls), h = t(e.orderControls || l.orderControls), u = e.controlsSelecter || l.controlsSelecter, p = e.controlsSelecterChecked || l.controlsSelecterChecked, o = 1, S = r.parent().hasClass("show-all-pages") ? 999 : 5;
            var L = t(".phantom-sticky").exists(),
                z = t(".sticky-top-line").exists(),
                E = t(".phantom-fade").exists(),
                O = t(".phantom-slide").exists(),
                P = (t(".split-header").exists(), 0);
            return L || z ? P = t(".masthead").height() : (E || O) && (P = t("#phantom").height()), (v = t([])).$nodesCache = t([]), r.find("> article, .wf-cell").each((function() {
                    var e = t(this);
                    v.push({
                        node: this,
                        $node: e,
                    ...
                    if ("pages" === w) {
                        if (y.empty(), y.addClass("hidden"), b > 1) {
                            y.removeClass("hidden"), 1 !== o && y.prepend('<a href="#" class="filter-item ' + (e.previousButtonClass || l.previousButtonClass) + '">' + (e.previousButtonLabel || l.previousButtonLabel) + "</a>");
                            var s = S - 1,
                                a = Math.floor(s / 2),
                                r = Math.ceil(s / 2),
                                d = Math.max(o - a, 1),
                            ...
                            o < b && y.append('<a href="#" class="filter-item ' + (e.nextButtonClass || l.nextButtonClass) + '">' + (e.nextButtonLabel || l.nextButtonLabel) + "</a>"), y.find('a[data-page="' + o + '"]').addClass(e.activeClass || l.activeClass);
                            ...
                            g = g.trim().replace(" ", "."), y.find("a.dots").click((function(e) {
                                ...
                                i.preventDefault(), o = parseInt(t(this).attr("data-page")), y.find("a." + (e.activeClass || l.activeClass)).removeClass(e.activeClass || l.activeClass), y.find('a[data-page="' + o + '"]').addClass(e.activeClass || l.activeClass), f()
                            })), y.find("a." + (e.previousButtonClass || l.previousButtonClass)).click((function(t) {
                                t.preventDefault(), o--, f()
                            })), y.find("a." + (e.nextButtonClass || l.nextButtonClass)).click((function(t) {
                                t.preventDefault(), o++, f()
                            }))
                        }
                    } else if ("load-more" === w && (y.addClass("hidden"), b > 1)) {
                        o < b && y.removeClass("hidden");
                        var v = e.loadMoreButtonClass || l.loadMoreButtonClass;
                        return v = v.trim().replace(" ", "."), y.find("a:not(.filtrade-ready)." + v).click((function(e) {
                            return e.preventDefault(), t(this).addClass("filtrade-ready"), !(o >= b) && (o++, x())
                        }))
                    }
                }, f = function() {
                    ...
                    if ("pages" === w || "load-more" === w) {
                        var n = 0,
                            ...
                            a = t([]);
                        v.each((function(t) {
                            this.$node.hasClass("visible") && (n++, "pages" === w && n > o * (e.pageLimit || l.pageLimit) - (e.pageLimit || l.pageLimit) && n <= (e.pageLimit || l.pageLimit) * o || "load-more" === w && n <= (e.pageLimit || l.pageLimit) * o ? a.push(this.node) : s.push(this.node))
                ...
                function() {
                    return (e.useFilters || l.useFilters) && (i = d.find(p).attr("data-filter") || e.defaultFilter || l.defaultFilter, d.find(u).click((function(e) {
                        i = t(this).attr("data-filter"), o = 1, I = !0, x(), I = !1
                        ...
                        s = "date" === this.getAttribute("data-by") ? "date" : "name", T(), o = 1, x()
                    })), h.find(u).click((function(t) {
                        a = "desc" === this.getAttribute("data-sort") ? "desc" : "asc", T(), o = 1, x()
                    }))), x()
                }()
        }
    ...
    function(t) {
        var e = function(e, i) {
            var n, o, s, a, r, l, d, c, h, u, p, f, m = !1,
                ...
                C = function() {
                    return !(o >= p) && (o++, k("loadMoreButton"), !0)
                },
                _ = function(t) {
                    r.trigger("beforeSwitchPage"), x(t), k("switchPage"), r.trigger("afterSwitchPage", [o])
                },
                x = function(t) {
                ...
                k = function(e = "") {
                    var i, s;
                    i = t([]), s = t([]), w.useFilters ? n === w.selectAll ? s = h.$nodesCache : h.each((function(t) {
                            this.$node.hasClass(n.replace(/^\./, "")) ? s.push(this.node) : i.push(this.node)
                        })) : s = h.$nodesCache, i.removeClass(w.classes.visible).addClass(w.classes.hidden), s.removeClass(w.classes.hidden).addClass(w.classes.visible),
                        function() {
                            ...
                            if ("pages" === w.paginationMode) {
                                if (u.empty(), u.addClass(w.classes.hidden), p > 1) {
                                    ...
                                    g = g.trim().replace(" ", "."), I("pagesDots", u.find("a.dots"), "click", (function(e) {
                                        ...
                                        e.preventDefault(), o = parseInt(t(this).attr("data-page")), u.find("a." + w.activeClass).removeClass(w.activeClass), u.find('a[data-page="' + o + '"]').addClass(w.activeClass), _(t(this))
                                    })), I("pagesPrev", u.find("a." + w.previousButtonClass), "click", (function(e) {
                                        e.preventDefault(), o--, _(t(this))
                ...
                T = function(i) {
                    r = t(e),
                        function(e) {
                            ...
                            n = t(this).attr("data-filter"), o = 1, m = !0, k("filtersFilterControl"), m = !1
                            ...
                            s = "date" === this.getAttribute("data-by") ? "date" : "name", S(), o = 1, k("sortSortControls")
                        })), I("sortOrderControls", c.find(w.controlsSelecter), "click", (function(t) {
                            a = "desc" === this.getAttribute("data-sort") ? "desc" : "asc", S(), o = 1, k("sortOrderControls")
                        }))), w.infinityScroll && (g = new The7Scroll({
                            offset: "0% 0% 25%",
                            callback: t => {
                                t.isInViewport && (g.unobserve(f[0]), C() && g.observe(f[0]))
                            }
                        }).getScrollObserver()).observe(f[0]), k("init")
                },
                I = function(t, e, i, n) {
                    e.length && (L(t), e.on(i, n), v[t] = {
                        element: e,
                        eventName: i,
                        callback: n
                    })
...
the7Utils.parseIntParam = function(t, e) {
    ...
    function(t, e) {
        ...
        function o(e, s) {
            this.element = e, this.$element = t(e), this.options = t.extend(!0, {}, n, s), this._defaults = n, this._name = i, o.prototype.plugin = this, this._init()
        }
        o.prototype = {
            version: function() {
            ...
            if (o.prototype[e] && -1 === e.indexOf("_")) {
                var n = t.data(this[0], "plugin_" + i);
                if (n) return o.prototype[e].apply(n, Array.prototype.slice.call(arguments, 1));
                t.error("jquery." + i + " plugin must be initialized first on the element")
            } else {
                if ("object" == typeof e || !e) return this.each((function() {
                    t.data(this, "plugin_" + i) ? t.error("jquery." + i + " plugin cannot be instantiated multiple times on same element") : t.data(this, "plugin_" + i, new o(this, e))
                }));
                t.error("Method " + e + " does not exist on jquery." + i)
            }
        }
    }(jQuery, window, document),
    function(t, e) {
        ...
        t.createFocusTrap = function(t, i) {
            var n, p = (null == i ? void 0 : i.document) || document,
                        ...
                        if (l < 0) r = a ? g.tabbableGroups[g.tabbableGroups.length - 1].lastTabbableNode : g.tabbableGroups[0].firstTabbableNode;
                            ...
                            if (v < 0 && (c.container === i || e.isFocusable(i, m.tabbableOptions) && !e.isTabbable(i, m.tabbableOptions) && !c.nextTabbableNode(i)) && (v = l), v >= 0) {
                                var b = v === g.tabbableGroups.length - 1 ? 0 : v + 1,
                                    _ = g.tabbableGroups[b];
                                r = e.getTabIndex(i) >= 0 ? _.firstTabbableNode : _.firstDomTabbableNode
                ...
                I = function(t) {
                    ...
                    if (n || i instanceof Document) n && (g.mostRecentlyFocusedNode = i);
                        ...
                        })), x(o || g.mostRecentlyFocusedNode || b())
                    }
                ...
                O = function() {
                    if (g.active) return function(t, e) {
                        ...
                        x(b())
                    })) : x(b()), p.addEventListener("focusin", I, !0), p.addEventListener("mousedown", T, {
                        capture: !0,
                        passive: !1
                        ...
                        capture: !0,
                        passive: !1
                    }), p.addEventListener("keydown", z), n
                },
                P = function() {
                    if (g.active) return p.removeEventListener("focusin", I, !0), p.removeEventListener("mousedown", T, !0), p.removeEventListener("touchstart", T, !0), p.removeEventListener("click", E, !0), p.removeEventListener("keydown", L, !0), p.removeEventListener("keydown", z), n
                },
                A = "undefined" != typeof window && "MutationObserver" in window ? new MutationObserver((function(t) {
                    t.some((function(t) {
                ...
                D = function() {
                    A && (A.disconnect(), g.active && !g.paused && g.containers.map((function(t) {
                        A.observe(t, {
                            subtree: !0,
                            childList: !0
                        })
            ...
            return (n = {
                ...
                deactivate: function(t) {
                    ...
                    clearTimeout(g.delayInitialFocusTimer), g.delayInitialFocusTimer = void 0, P(), g.active = !1, g.paused = !1, D(),
                        function(t, e) {
                    ...
                    var d = function() {
                        l((function() {
                            r && x(S(g.nodeFocusedBeforeActivation)), null == s || s()
                        }))
                    };
                ...
                pause: function(t) {
                    ...
                    var e = v(t, "onPause"),
                        i = v(t, "onPostPause");
                    return g.paused = !0, null == e || e(), P(), D(), null == i || i(), this
                },
                unpause: function(t) {
                    if (!g.paused || !g.active) return this;
                    var e = v(t, "onUnpause"),
                        i = v(t, "onPostUnpause");
                    return g.paused = !1, null == e || e(), C(), O(), D(), null == i || i(), this
                },
    ...
    function(t) {
        function e() {
            return t('<span class="avatar no-avatar"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16" style="enable-background:new 0 0 16 16;" xml:space="preserve"><path d="M8,8c2.2,0,4-1.8,4-4s-1.8-4-4-4S4,1.8,4,4S5.8,8,8,8z M8,10c-2.7,0-8,1.3-8,4v1c0,0.5,0.4,1,1,1h14c0.5,0,1-0.5,1-1v-1 C16,11.3,10.7,10,8,10z"/></svg></span>')
        }
        var i;
        ...
        t.fn.exists = function() {
            ...
            void 0 !== i ? (this.each((function() {
                ...
                nodesFilter: function(t) {
                    return !t.classList.contains("composite_component")
                }
            })
        ...
        onWindowWidthResizeDebounced = r((function() {
                ...
                function t() {
                    a('[data-vc-full-width="true"]').each((function() {
                        var t, e, i = a(this),
                            ...
                            c = window.innerWidth,
                            h = n.width(),
                            u = c > dtLocal.themeSettings.mobileHeader.firstSwitchPoint,
                            p = a("#main > .wf-wrap"),
                            f = p.length ? parseInt(p.css("width")) : parseInt(a(".wpb-content-wrapper").css("width")),
                            m = (a("#content"), a("#content").length ? a("#content").width() : i.find(".vc_column_container").innerWidth()),
                            g = Math.max(m, h),
                            v = p.length ? parseInt(p.css("padding-left")) : 0,
            ...
            function(t) {
                ...
                var i = t.event.add,
                    ...
                    s = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t, e) {
                ...
                function S(t) {
                    var e = t.data;
                    w(t.changedTouches, e.identifier) && k(e.identifier)
                }

                function k(t) {
                    n(document, "." + t, x), n(document, "." + t, S)
                }

                function T(t, e, i, n) {
                    var s = i.pageX - e.startX,
                        a = i.pageY - e.startY;
                    s * s + a * a < 36 || function(t, e, i, n, s, a) {
                        var r, l;
                        e.target;
                        r = t.targetTouches, l = t.timeStamp - e.timeStamp, e.type = "movestart", e.distX = n, e.distY = s, e.deltaX = n, e.deltaY = s, e.pageX = i.pageX, e.pageY = i.pageY, e.velocityX = n / l, e.velocityY = s / l, e.targetTouches = r, e.finger = r ? r.length : 1, e._handled = I, e._preventTouchmoveDefault = function() {
                            t.preventDefault()
                        }, o(e.target, e), a(e.identifier)
                    }(t, e, i, s, a, n)
                }
                ...
                function E(t) {
                    var e = t.data.event,
                        i = t.data.timer;
                    n(document, r, z), n(document, d, E), A(e, i, (function() {
                        setTimeout((function() {
                            n(e.target, "click", m)
                        }), 0)
                    }))
                ...
                function P(t) {
                    ...
                    w(t.changedTouches, e.identifier) && (! function(t) {
                        n(document, "." + t.identifier, O), n(document, "." + t.identifier, P)
                    }(e), A(e, i))
                }
                ...
                t.event.special.movestart = {
                    setup: function(t, e, n) {
                        return i(this, "movestart.move", L), !0
                    },
                    teardown: function(t) {
                        return n(this, "dragstart drag", g), n(this, "mousedown touchstart", v), n(this, "movestart", L), !0
                    },
                    add: function(t) {
                    ...
                    _default: function(t) {
                        ...
                        t._handled() && (n = {
                            ...
                            timer: new p((function(e) {
                                ...
                                }(n, s.touch, s.timeStamp), o(t.target, n)
                            })),
                            touch: e,
                            timeStamp: e
                        }, t.identifier === e ? (i(t.target, "click", m), i(document, r, z, s), i(document, d, E, s)) : (t._preventTouchmoveDefault(), i(document, c + "." + t.identifier, O, s), i(document, u + "." + t.identifier, P, s)))
                    }
                    ...
                    }, i(document, c + "." + e.identifier, x, n), i(document, h + "." + e.identifier, S, n))
        ...
        function w(t, e = {}) {
            ...
            i.innerHTML = t;
            const n = Object.keys(e).length > 0 ? e : {
                p: ["class", "id"],
                div: ["class", "id"],
                span: ["class", "id"],
                br: [],
            ...
            function o(t) {
                if (t.nodeType === Node.ELEMENT_NODE) {
                    ...
                    if (!n.hasOwnProperty(e)) return void t.remove();
                    const i = Array.from(t.attributes),
                        s = n[e] || [];
                    i.forEach((e => {
                        if (t.removeAttribute(e.name), s.includes(e.name.toLowerCase())) {
                            let i = e.value;
                            if ("href" === e.name.toLowerCase() || "src" === e.name.toLowerCase()) {
                                if (/^(javascript|data|vbscript):/i.test(i.trim())) return
                            }
                            t.setAttribute(e.name, function(t) {
            ...
            return i.querySelectorAll("script").forEach((t => t.remove())), Array.from(i.children).forEach((t => {
                o(t)
            })), i.innerHTML
        }
            ...
            ! function(e) {
                n = [], e.each((function(e, i) {
                    n.push({
                        ...
                        if (u = w(u), r.data("gallery-id", e + 1), r.data("photo-id", i), void 0 === d && (d = r.find("img").width()), void 0 === h && (h = r.find("img").height()), t(s).hasClass("pswp-video")) {
                            var p = s.href,
                                f = o.embedType;
        ...
        if (t.fn.photoswipeGallery = function(e) {
                        ...
                        r = function(e) {
                            for (var i, n, o = t(e).find(".photoswipe-item").get(), s = o.length, a = [], r = 0; r < s; r++)
                                if (1 === (i = o[r]).nodeType) {
                                    ...
                                    if (c = w(c), t(n).hasClass("pswp-video")) {
                                        var h, u = n.href;
                                        t.each(g, (function() {
                ...
                return t.embedType = "hosted", y(t, this)
            }, dtGlobals.addOnloadEvent((function() {
                ...
                return t.target = ".dt-owl-item.cloned .dt-pswp-item", y(t, this)
            }, t.fn.initCarouselClonedPhotoswipe = function() {
                return b(this, "photoswipeCarousel")
            }, t.fn.initPhotoswipe = function() {
                return b(this, "photoswipe")
            ...
            function(t) {
                ...
                function r(n, o) {
                    ...
                    return t.each((n + " " + i.join(a + " ") + a).split(" "), (function(t, i) {
                        if (undefined !== e[i]) return s = !o || i, !1
                    })), s
                }
                ...
                function l(t) {
                    ...
                    return !!r("transition")
                })() && (t.support.transition = new String(l("transition")), t.support.transition.end = n.transition.end[t.support.transition]), a() && (t.support.animation = new String(l("animation")), t.support.animation.end = n.animation.end[t.support.animation]), o() && (t.support.transform = new String(l("transform")), t.support.transform3d = s())
            }(window.Zepto || window.jQuery, window, document)
        }
        ...
        var _ = t(".slider-wrapper.owl-carousel:not(.related-projects)");
        _.each((function() {
            var e, i = t(this),
                ...
                r = i.attr("data-width") ? _.width() / parseInt(i.attr("data-width")) : _.width() / _.find("article img").attr("width"),
            ...
            r = i.attr("data-width") ? _.width() / parseInt(i.attr("data-width")) : i.attr("data-max-width") ? _.width() / parseInt(i.attr("data-max-width")) : _.width() / _.find("article img").attr("width"), i.owlCarousel({
                rtl: l,
                items: r,
                autoHeight: !1,
                margin: n,
        ...
        var x, S = t("#main .slider-content, #footer .slider-content, .side-header:not(.sub-downwards) .mega-full-width > .dt-mega-menu-wrap  .slider-content, .side-header:not(.sub-downwards) .mega-auto-width > .dt-mega-menu-wrap  .slider-content");
        ...
        }, S.widgetScroller().css("visibility", "visible");
        var k;
        ...
        t.fn.the7OwlCarousel = function() {
            ...
            if (e.length) {
                ...
                var S = e.find(".owl-dot");
                S.each((function(e) {
                    t(this).attr("aria-label", "Go to slide " + (e + 1))
                })), S.removeAttr("aria-current"), S.filter(".active").attr("aria-current", "true"), e.find(".owl-dots").attr("role", "tablist");
                var k = e.find(".owl-nav");
                k.find(".owl-prev").attr("role", "button").attr("tabindex", "0").attr("aria-label", "Previous slide"), k.find(".owl-next").attr("role", "button").attr("tabindex", "0").attr("aria-label", "Next slide")
            }
            ...
            e.on("changed.owl.carousel", (function(t) {
                var i = e.find(".owl-dot");
                i.removeAttr("aria-current"), setTimeout((function() {
                    i.filter(".active").attr("aria-current", "true")
                }), 0)
            }));
            var g = function() {
                ...
                e.hasClass("albums-shortcode") && (e.hasClass("gradient-overlay-layout-list") || e.hasClass("content-rollover-layout-list") ? the7Utils.isFunction(t.fn.triggerClonedOverlayAlbumsClick) && t(" .dt-owl-item.cloned .post-entry-content", e).triggerClonedOverlayAlbumsClick() : the7Utils.isFunction(t.fn.triggerClonedAlbumsClick) && i.triggerClonedAlbumsClick()), e.hasClass("gallery-shortcode") && t(e).initCarouselClonedPhotoswipe(), e.find(".owl-dots").attr("role", "tablist");
                var n = e.find(".owl-dot");
                n.each((function(e) {
                    t(this).attr("aria-label", "Go to slide " + (e + 1))
                })), n.removeAttr("aria-current"), n.filter(".active").attr("aria-current", "true")
            };
            ...
            $spg = new class {
                ...
                generateSwitchPointData(t) {
                    const e = The7ElementorSettings.getResponsiveControlValue(this.widgetSettings, this.config.columnsKey, "", t) || 3,
                        i = The7ElementorSettings.getResponsiveControlValue(this.widgetSettings, this.config.gapKey, "size", t) || 15;
                    return {
            ...
            t(".elementor-owl-carousel-call:not(.the7-woocommerce-loop-product-image)").each((function() {
                ...
                var d = s.find(".owl-dot");
                d.each((function(e) {
                    t(this).attr("aria-label", "Go to slide " + (e + 1))
                })), d.removeAttr("aria-current"), d.filter(".active").attr("aria-current", "true"), s.find(".owl-dots").attr("role", "tablist");
                var c = s.find(".owl-nav");
                c.find(".owl-prev").attr("role", "button").attr("tabindex", "0").attr("aria-label", "Previous slide"), c.find(".owl-next").attr("role", "button").attr("tabindex", "0").attr("aria-label", "Next slide")
            }));
        ...
        var I = t(".top-bar"),
            ...
            A = (t(".header-side-left").length, t(".header-side-right").length, t("#main, #main-slideshow, .photo-scroller, .page-title, .fancy-header, .footer"), t(".floating-logo.side-header-menu-icon .branding, .side-header-h-stroke, #phantom"), t(".side-header")),
            D = (t(".page-template-template-microsite").length, s.hasClass("transparent")),
            M = t(".floating-navigation-below-slider").exists();
        if (t(".side-header-v-stroke").length > 0) A.width(), t(".side-header-v-stroke").width();
        else A.width();
        ...
        if (t.closeSideHeader = function() {
                ...
                a.removeClass("show-mobile-header"), a.addClass("closed-mobile-header"), s.removeClass("show-sticky-mobile-header show-overlay-mobile-header").addClass("closed-overlay-mobile-header"), t(".mobile-sticky-header-overlay, .dt-mobile-menu-icon, .menu-toggle, .menu-close-toggle").removeClass("active"), i.trigger("the7_mobile_header_closed")
            }, E.length > 0 || z.length > 0) {
            ...
            var F = dtLocal.themeSettings.ToggleCaptionEnabled;
            ToggleCaption = "disabled" != F ? "<span class='menu-toggle-caption'>" + dtLocal.themeSettings.ToggleCaption + "</span>" : "", E.length > 0 && s.append('<div class="sticky-header-overlay"></div>');
            var H = t(".menu-toggle"),
                B = t(".menu-close-toggle"),
                R = t(".menu-toggle:not(.active), .menu-close-toggle:not(.active)"),
                W = t(".sticky-header-overlay");
            H.on("click", (function() {
                if (!t(".header-under-side-line").length > 0) var e = t(".side-header .menu-toggle");
                else e = t(".menu-toggle");
                e.hasClass("active") ? (e.removeClass("active"), a.removeClass("show-header").addClass("closed-header"), W.removeClass("active"), t(".hide-overlay").removeClass("active")) : (R.removeClass("active"), e.addClass("active").css({
                    left: "",
                    right: ""
                }), a.addClass("show-header").removeClass("closed-header"), B.addClass("active"), W.addClass("active"), t(".hide-overlay").addClass("active"))
            })), B.on("click", (function() {
                var e = t(this);
                e.hasClass("active") ? (e.removeClass("active"), a.removeClass("show-header").addClass("closed-header"), W.removeClass("active"), t(".hide-overlay").removeClass("active")) : (R.removeClass("active"), e.addClass("active").css({
                    left: "",
                    right: ""
                }), a.addClass("show-header").removeClass("closed-header"), W.addClass("active"), t(".hide-overlay").addClass("active"))
            })), W.on("click", (function() {
                t(this).hasClass("active") && (R.removeClass("active"), a.removeClass("show-header").addClass("closed-header"), W.removeClass("active"))
            })), t(".hide-overlay").on("click", (function() {
                t(this).hasClass("active") && (R.removeClass("active"), a.removeClass("show-header"), a.addClass("closed-header"), W.removeClass("active"))
            }))
        }
        ...
        function j() {
            ...
            if ((e - a.innerWidth()) / 2 > 0 && (i = (e - a.innerWidth()) / 2), s.hasClass("header-side-right") && a.hasClass("boxed") && !E.length > 0 && A.css({
                    right: i
                }), navigator.userAgent.match(/Trident.*rv\:11\./) && M && D) {
                L.insertAfter(P);
                var r = L.attr("style");
                L.not(".sticky-on").attr("style", r + "; top:" + P.height() + "px !important;")
            }
            var l = t(".floating-menu-icon-right");
            l.length > 0 && a.hasClass("boxed") && (R.css({
                right: i
            }), t(".branding").css({
                left: i
                ...
                left: i
            })), z.length > 0 && o && a.hasClass("boxed") && (R.css({
                right: i
            }), t(".floating-logo .branding").css({
                left: i
            }))
        }
        if (j(), n.on("the7-resize-width-debounce", (function() {
                j()
            })), M && s.hasClass("footer-overlap") && L.insertAfter(P), navigator.userAgent.match(/Trident.*rv\:11\./) && M && D) {
            L.insertAfter(P);
            var $ = L.attr("style");
            L.attr("style", $ + "; top:" + P.height() + "px !important;")
        }
        var N = L;
        if (t(".mixed-header").length > 0 && (N = t(".mixed-header")), t(".side-header .header-bar").wrap("<div class='header-scrollbar-wrap'></div>"), A.length > 0 && "function" == typeof t.fn.mCustomScrollbar && !dtGlobals.isMobile && (t(".header-scrollbar-wrap").mCustomScrollbar({
                scrollInertia: 150,
                callbacks: {
            ...
            }), t(".sub-downwards .main-nav").find(".slider-content").widgetScroller().css("visibility", "visible")), A.length > 0 && !t(".mCSB_container").length > 0 && t(".side-header .header-scrollbar-wrap .header-bar").wrap("<div class='mCSB_container'></div>"), !s.hasClass("responsive-off")) {
            var G = t(".mixed-header"),
                Y = t(".masthead .near-logo-first-switch").clone(!0).addClass("show-on-first-switch"),
                q = t(".masthead .near-logo-second-switch").clone(!0).addClass("show-on-second-switch"),
                U = L.find(".in-menu-first-switch").clone(!0).addClass("hide-on-desktop hide-on-second-switch show-on-first-switch"),
                V = L.find(".in-menu-second-switch").clone(!0).addClass("hide-on-desktop hide-on-first-switch show-on-second-switch"),
                X = L.find(".in-top-bar").clone(!0).addClass("hide-on-desktop hide-on-first-switch show-on-second-switch"),
                Z = L.find(".in-top-bar-left").clone(!0).addClass("hide-on-desktop show-on-first-switch"),
                Q = L.find(".in-top-bar-right").clone(!0).addClass("hide-on-desktop  show-on-first-switch");
            if (G.length > 0) {
                var K = G.find(".branding > a, .branding > img").clone(!0);
                N = G
            } else K = t(".masthead:not(.mixed-header)").find(".branding > a, .branding > img").clone(!0), N = L;
            if (I.length > 0 && "none" != I.css("display")) var J = I.innerHeight();
            else J = 0;
            var tt = dtLocal.themeSettings.mobileHeader.mobileToggleCaptionEnabled;
            mobileToggleCaption = "disabled" != tt ? "<span class='menu-toggle-caption'>" + dtLocal.themeSettings.mobileHeader.mobileToggleCaption + "</span>" : "", t("<div class='mobile-header-bar'><div class='mobile-navigation'></div><div class='mobile-mini-widgets'></div><div class='mobile-branding'></div></div>").appendTo(".masthead"), t(".mobile-header-bar .mobile-navigation").append("<a href='#' class='dt-mobile-menu-icon' aria-label='Mobile menu icon' aria-haspopup='true' aria-controls='menu'>" + mobileToggleCaption + "<div class='lines-button '><span class='menu-line'></span><span class='menu-line'></span><span class='menu-line'></span></div></a>"), t(Y).appendTo(".mobile-header-bar .mobile-mini-widgets"), t(q).appendTo(".mobile-header-bar .mobile-mini-widgets"), t(".left-widgets", I).append(X), t(".left-widgets", I).append(Z), t(".right-widgets", I).append(Q).removeClass("select-type-menu list-type-menu select-type-menu-second-switch list-type-menu-second-switch"), t(".right-widgets", I).append(Q).removeClass("select-type-menu list-type-menu select-type-menu-second-switch list-type-menu-second-switch"), t(U).appendTo(".mobile-mini-widgets-in-menu"), t(V).appendTo(".mobile-mini-widgets-in-menu"), U.removeClass("select-type-menu list-type-menu select-type-menu-second-switch list-type-menu-second-switch"), V.removeClass("select-type-menu list-type-menu select-type-menu-first-switch list-type-menu-first-switch"), t(".mobile-header-bar .mobile-branding").append(K);
            var et = t(".dt-mobile-header");
            et.siblings().hasClass("dt-parent-menu-clickable") && et.addClass("dt-parent-menu-clickable");
            var it = t(".mobile-mini-widgets-in-menu");
            ...
            if (it.find(".in-menu-first-switch ").length || it.addClass("first-switch-no-widgets"), it.find(".in-menu-second-switch ").length || it.addClass("second-switch-no-widgets"), Y.removeClass("select-type-menu list-type-menu select-type-menu-second-switch list-type-menu-second-switch"), q.removeClass("select-type-menu list-type-menu select-type-menu-first-switch list-type-menu-first-switch"), X.removeClass("show-on-desktop select-type-menu list-type-menu select-type-menu-first-switch list-type-menu-first-switch in-top-bar-left").addClass("hide-on-desktop hide-on-first-switch"), Z.removeClass("show-on-desktop select-type-menu list-type-menu select-type-menu-second-switch list-type-menu-second-switch in-top-bar").addClass("hide-on-desktop hide-on-second-switch"), Q.removeClass("show-on-desktop select-type-menu list-type-menu  select-type-menu-second-switch list-type-menu-second-switch").addClass("hide-on-desktop"), t(".header-bar .mini-widgets > .mini-nav ").removeClass("select-type-menu-second-switch list-type-menu-second-switch select-type-menu-first-switch list-type-menu-first-switch"), t(".mini-nav.show-on-desktop:not(.show-on-first-switch):not(.show-on-second-switch)", I).removeClass("select-type-menu-second-switch list-type-menu-second-switch select-type-menu-first-switch list-type-menu-first-switch"), t(".masthead .hide-on-desktop").addClass("display-none"), t(".mobile-main-nav ").find("li").each((function() {
                    ...
                    i.unwrap()
                })).removeClass("dt-mega-menu dt-mega-parent hide-mega-title").find(" > .sub-nav").removeClass(" hover-style-bg"), et.length > 0) {
                dtGlobals.mobileMenuPoint = 50;
                var nt = t(".dt-mobile-menu-icon"),
                    ot = !1,
                    st = N.offset().top;
                if (!t(".floating-btn").length > 0 && t(".floating-mobile-menu-icon").length > 0) nt.first().clone(!0).insertBefore(nt).addClass("floating-btn");
                var at = t(".floating-btn");
                n.scroll((function() {
                    dtGlobals.mobileMenuPoint = st + N.height() + 50, dtGlobals.winScrollTop > dtGlobals.mobileMenuPoint && !1 === ot ? (at.parents(".masthead").addClass("show-floating-icon"), ot = !0) : dtGlobals.winScrollTop <= dtGlobals.mobileMenuPoint && !0 === ot && (at.parents(".masthead").removeClass("show-floating-icon"), ot = !1)
                }));
                nt = t(".dt-mobile-menu-icon");
                !t(".mobile-sticky-header-overlay").length > 0 && s.append('<div class="mobile-sticky-header-overlay"></div>');
                var rt = t(".mobile-sticky-header-overlay");
                const xi = t(".dt-close-mobile-menu-icon"),
                    Si = window.focusTrap.createFocusTrap(".dt-mobile-header", {
                        escapeDeactivates: !1,
                ...
                i.on("the7_mobile_header_closed", (function() {
                    Si.deactivate()
                }));
                const ki = function(t) {
                        "Escape" === t.key && a.hasClass("show-mobile-header") && xi.trigger("click")
                    },
                    Ti = function() {
                        document.addEventListener("keydown", ki)
                    },
                    Ii = function() {
                        document.removeEventListener("keydown", ki)
                    };
                nt.on("click", (function(e) {
                    e.preventDefault();
                    var i = t(this);
                    i.hasClass("active") ? (i.removeClass("active"), a.removeClass("show-mobile-header").addClass("closed-mobile-header"), s.removeClass("show-mobile-overlay-header").addClass("closed-overlay-mobile-header"), i.parents("body").removeClass("show-sticky-mobile-header"), rt.removeClass("active"), Si.deactivate()) : (nt.removeClass("active"), i.addClass("active"), a.addClass("show-mobile-header").removeClass("closed-mobile-header"), s.removeClass("closed-overlay-mobile-header").addClass("show-overlay-mobile-header"), rt.removeClass("active"), i.parents("body").addClass("show-sticky-mobile-header"), rt.addClass("active"), Si.activate())
                })), rt.on("click", (function() {
                    t(this).hasClass("active") && (nt.removeClass("active"), a.removeClass("show-mobile-header").addClass("closed-mobile-header"), s.removeClass("show-sticky-mobile-header").addClass("closed-overlay-mobile-header").addClass("closed-overlay-mobile-header"), rt.removeClass("active"), a.removeClass("show-mobile-sidebar"), Si.deactivate())
                })), xi.on("click", (function() {
                    a.removeClass("show-mobile-header"), a.addClass("closed-mobile-header"), s.removeClass("show-sticky-mobile-header"), s.removeClass("show-overlay-mobile-header").addClass("closed-overlay-mobile-header"), rt.removeClass("active"), nt.removeClass("active"), a.removeClass("show-mobile-header"), a.addClass("closed-mobile-header"), s.removeClass("show-sticky-mobile-header show-overlay-mobile-header").addClass("closed-overlay-mobile-header"), t(".mobile-sticky-header-overlay, .dt-mobile-menu-icon, .menu-toggle, .menu-close-toggle").removeClass("active"), Si.deactivate()
                })), xi.on("keydown", (function(e) {
                    "Enter" === e.key && t(this).trigger("click")
                })), t(".dt-mobile-header").wrapInner("<div class='mobile-header-scrollbar-wrap'></div>"), t(".mobile-header-scrollbar-wrap").layzrInitialisation();
                ...
                t(".dt-mobile-header").on("scroll", Li), et.find(".slider-content").widgetScroller().css("visibility", "visible"), !t(".touchevents").length > 0 && (et.on("mouseenter", (function(t) {
                    et.css("overflow-y", "auto")
                })), et.on("mouseleave", (function(t) {
                    et.css("overflow-y", "hidden")
                })))
            }
        }
        ...
        var lt = t(".main-nav, .mini-nav, .mini-wpml .wpml-ls-item-legacy-dropdown"),
            dt = t(".masthead:not(.sub-downwards) .main-nav, .mini-nav, .mini-wpml .wpml-ls-item-legacy-dropdown"),
            ct = t(".main-nav");
        A = t(".side-header");
        ...
        var ht, ut, pt = t(".select-type-menu, .select-type-menu-first-switch, .select-type-menu-second-switch, .mini-wpml .wpml-ls-item-legacy-dropdown"),
            ft = "mini-sub-nav";
        pt.find("> ul").addClass(ft), t(".mini-wpml .wpml-ls-item-legacy-dropdown").find("> ul").addClass(ft), dt.each((function() {
            var e = t(this);
            t(".act", e).parents("li").addClass("act"), t(" li.has-children ", e).each((function() {
                ...
                if ((dtGlobals.isMobile || dtGlobals.isWindowsPhone) && o.find("> a").on("click", (function(e) {
                        t(this).hasClass("dt-clicked") ? e.stopPropagation() : (e.preventDefault(), lt.find(".dt-clicked").removeClass("dt-clicked"), t(this).addClass("dt-clicked"))
                    })), lt.parents().hasClass("full-width") && o.hasClass("mega-full-width")) {
                    if (lt.parents(".header-bar").length > 0) var l = lt.parents(".header-bar").innerWidth();
                    else l = lt.parents(".ph-wrap").innerWidth();
                    !A.length > 0 && o.find(".sub-nav-widgets").css({
                        width: l
                    })
                }
                ...
                function d(o) {
                    ...
                    if (s.addClass("dt-hovered"), s.hasClass("dt-mega-menu") && s.addClass("show-mega-menu"), dtGlobals.isHovering = !0, r.length > 0 && (a.width() - (r.offset().left - a.offset().left) - r.width() < 0 && r.addClass("right-overflow"), n.height() - (r.offset().top - dtGlobals.winScrollTop) - r.innerHeight() < 0 && !r.parents().hasClass("sub-sideways") && r.addClass("bottom-overflow"), n.height() - (r.offset().top - dtGlobals.winScrollTop) - r.innerHeight() < 0 && !s.hasClass("dt-mega-menu") && r.addClass("bottom-overflow")), (s.find(".dt-mega-menu-wrap").length > 0 && s.find(".dt-mega-menu-wrap").offset().top + s.find(".dt-mega-menu-wrap").innerHeight()) > n.height() && r.parents().hasClass("sub-sideways") && s.hasClass("dt-mega-menu") && (o.find(".dt-mega-menu-wrap").height() <= n.height() ? s.find(".dt-mega-menu-wrap").css({
                        ...
                        })), !A.length > 0 && r.not(".right-overflow").css({
                            left: d - l
                        ...
                        var h = c.offset().left,
                            u = s.offset().left;
                        if ($_this_parents_ofs = s.offset().left - h, !A.length) {
                            var p = a.width();
                            if (t(".boxed").length > 0) {
                                u = s.position().left;
        ...
        }, t(".mobile-true .main-nav .has-children > a").touchMenuItem(), pt.on("mouseenter tap", (function(e) {
            "tap" == e.type && e.stopPropagation();
            var i = t(this);
            ...
            }), dtGlobals.isHovering = !0, clearTimeout(ht), clearTimeout(ut), ht = setTimeout((function() {
        ...
        })), pt.on("mouseleave", (function(e) {
            var i = t(this);
            i.removeClass("dt-hovered"), dtGlobals.isHovering = !1, clearTimeout(ht), clearTimeout(ut), ut = setTimeout((function() {
        ...
        var mt = t(".sticky-mobile-header").exists();
        window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !s.hasClass("responsive-off") && (t(".masthead:not(.side-header):not(#phantom)").addClass("masthead-mobile-header"), t("body:not(.overlay-navigation):not(.sticky-header) .side-header:not(#phantom)").addClass("masthead-mobile-header").addClass("desktop-side-header")), window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && window.innerWidth > dtLocal.themeSettings.mobileHeader.secondSwitchPoint && !s.hasClass("responsive-off") ? t(".left-widgets", I).find(".in-top-bar-left").length > 0 || t(".right-widgets", I).find(".in-top-bar-right").length > 0 ? I.removeClass("top-bar-empty") : I.addClass("top-bar-empty") : window.innerWidth <= dtLocal.themeSettings.mobileHeader.secondSwitchPoint && !s.hasClass("responsive-off") ? t(".left-widgets", I).find(".in-top-bar").length > 0 ? I.removeClass("top-bar-empty") : I.addClass("top-bar-empty") : !t(".mini-widgets", I).find(".show-on-desktop").length > 0 ? I.addClass("top-bar-empty") : I.removeClass("top-bar-empty");
        var gt = t(".floating-navigation-below-slider").exists();
        if (t(".sticky-mobile-header").exists() && !s.hasClass("responsive-off")) {
            var vt = t(".masthead:not(.side-header):not(#phantom), body:not(.overlay-navigation):not(.sticky-header) .side-header:not(#phantom)"),
                wt = vt.find(".mobile-header-bar");
            $stickyMobileLogo = vt.find(".mobile-branding"), mobileLogoURL = t(".mobile-branding a").attr("href"), t(".sticky-mobile-logo-first-switch").exists() || dtLocal.themeSettings.stickyMobileHeaderFirstSwitch.logo.html && (null == mobileLogoURL ? t(dtLocal.themeSettings.stickyMobileHeaderFirstSwitch.logo.html).addClass("sticky-mobile-logo-first-switch").prependTo($stickyMobileLogo) : t('<a class="sticky-mobile-logo-first-switch" href="' + mobileLogoURL + '">' + dtLocal.themeSettings.stickyMobileHeaderFirstSwitch.logo.html + " </a>").prependTo($stickyMobileLogo)), t(".sticky-mobile-logo-second-switch").exists() || dtLocal.themeSettings.stickyMobileHeaderSecondSwitch.logo.html && (null == mobileLogoURL ? t(dtLocal.themeSettings.stickyMobileHeaderSecondSwitch.logo.html).addClass("sticky-mobile-logo-second-switch").prependTo($stickyMobileLogo) : t('<a class="sticky-mobile-logo-second-switch" href="' + mobileLogoURL + '">' + dtLocal.themeSettings.stickyMobileHeaderSecondSwitch.logo.html + " </a>").prependTo($stickyMobileLogo));
            var yt = 0,
                bt = 0,
                Ct = P.height(),
                _t = 0,
                ...
                St = !1;
            if (!D) {
                t("<div class='mobile-header-space'></div>").insertBefore(vt);
                var kt = t(".mobile-header-space")
            }
            t(".no-cssgridlegacy.no-cssgrid").length > 0 && gt && (D ? (vt.css({
                top: Ct
            }), kt.css({
                top: Ct
            })) : (kt.insertAfter(P), vt.insertAfter(P))), dtGlobals.resetMobileSizes = function(e) {
                if (window.innerWidth > dtLocal.themeSettings.mobileHeader.firstSwitchPoint) return t(".is-safari").length > 0 && vt.css({
                    width: "",
                    "max-width": ""
                }), vt.removeClass("sticky-mobile-off sticky-mobile-on"), St = !1, !1;
                bt = t("#wpadminbar").exists() && !Modernizr.mq("only screen and (max-width:600px)") ? t("#wpadminbar").height() : 0, window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && window.innerWidth > dtLocal.themeSettings.mobileHeader.secondSwitchPoint && !s.hasClass("responsive-off") ? t(".left-widgets", I).find(".in-top-bar-left").length > 0 || t(".top-bar .right-widgets").find(".in-top-bar-right").length > 0 ? I.removeClass("top-bar-empty") : I.addClass("top-bar-empty") : t(".left-widgets", I).find(".in-top-bar").length > 0 ? I.removeClass("top-bar-empty") : I.addClass("top-bar-empty"), yt = !I.exists() || I.is(":hidden") || I.hasClass("top-bar-empty") || I.hasClass("hide-top-bar") ? 0 : I.innerHeight(), window.innerWidth < dtLocal.themeSettings.mobileHeader.firstSwitchPoint && window.innerWidth > dtLocal.themeSettings.mobileHeader.secondSwitchPoint ? (_t = dtLocal.themeSettings.mobileHeader.firstSwitchPointHeight + yt, dtLocal.themeSettings.mobileHeader.firstSwitchPointHeight) : (_t = dtLocal.themeSettings.mobileHeader.secondSwitchPointHeight + yt, dtLocal.themeSettings.mobileHeader.secondSwitchPointHeight), gt ? gt && !D ? xt = e : gt && D ? xt = e - _t + yt : wt.offset().top : xt = yt, vt.hasClass("sticky-mobile-on") && vt.css({
                    top: bt - yt
                }), D || (kt.css({
                    height: _t
                }), kt.css({
                    top: e
                })), t(".is-safari").length > 0 && vt.css({
                    width: document.documentElement.clientWidth,
                    "max-width": document.documentElement.clientWidth
                })
            }, dtGlobals.resetMobileSizes(P.height()), n.on("resize debouncedresize", (function() {
                dtGlobals.resetMobileSizes(P.height())
            })), n.on("scroll", (function() {
                if (window.innerWidth > dtLocal.themeSettings.mobileHeader.firstSwitchPoint) return !1;
                var e = dtGlobals.winScrollTop;
                e > xt && !St && t(document).height() > t(window).height() ? (vt.removeClass("sticky-mobile-off").addClass("sticky-mobile-on"), M && mt && vt.addClass("fixed-mobile-header"), vt.css({
                    top: bt - yt
                }), St = !0) : e <= xt && St && (vt.removeClass("sticky-mobile-on").addClass("sticky-mobile-off"), M && mt && vt.removeClass("fixed-mobile-header"), vt.css({
                    top: 0
                }), t(".no-cssgridlegacy.no-cssgrid").length > 0 && gt && vt.css({
                    top: Ct
                }), St = !1)
            }))
        }
        dtGlobals.isMobile && window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !dtGlobals.isiPad && !s.hasClass("responsive-off") && (dtLocal.themeSettings.floatingHeader.showMenu && t(".phantom-sticky").exists() && D && L.addClass("fixed-masthead"), dtLocal.themeSettings.floatingHeader.showMenu = !1);
        D = s.hasClass("transparent");
        var Tt = t(".phantom-sticky").exists();
        t(".side-header").exists();
        if (dtLocal.themeSettings.floatingHeader.showMenu && Tt) {
            var It = t(".branding a", L).attr("href"),
                Lt = (E = L).find(".header-bar");
            (Wt = E.find(".branding")).find("img");
            Wt.find("a.same-logo").length > 0 || t(".sticky-logo").exists() || dtLocal.themeSettings.floatingHeader.logo.html && dtLocal.themeSettings.floatingHeader.logo.showLogo && (null == It ? t(dtLocal.themeSettings.floatingHeader.logo.html).addClass("sticky-logo").prependTo(Wt) : t('<a class="sticky-logo" href="' + It + '">' + dtLocal.themeSettings.floatingHeader.logo.html + " </a>").prependTo(Wt));
            J = 0;
            var zt = 0,
                Et = 0,
                Ot = 0,
                ...
                Dt = "";
            if (!D) {
                t("<div class='header-space'></div>").insertAfter(E);
                var Mt = t(".header-space")
            }
            E.addClass("sticky-off fixed-masthead");
            var Ft = !1;
            ...
            function Ht() {
                ...
                if (t > Pt + 1 && !At && !dtGlobals.isHovering) {
                    if (E.removeClass("sticky-off").addClass("sticky-on"), D || Mt.removeClass("sticky-space-off").addClass("sticky-space-on"), s.hasClass("floating-top-bar") ? E.css({
                            top: zt
                        }) : E.css({
                            top: zt - J
                        }), At = !0, gt && D && (E.css({
                        ...
                        var e = E.attr("style");
                        E.attr("style", e + "; top:" + J + "px !important;")
                    }
                } else if (t <= Pt + 1 && At && (E.removeClass("sticky-on").addClass("sticky-off"), D || Mt.removeClass("sticky-space-on").addClass("sticky-space-off"), E.css({
                        top: 0
                    }), At = !1, gt && D && (E.css({
                        transform: "translateY(-100%)"
                    }), navigator.userAgent.match(/Trident.*rv\:11\./)))) {
                    e = E.attr("style");
                    E.not(".sticky-on").attr("style", e + "; top:" + P.height() + "px !important;")
                }
                t > Pt + 1 && t <= Pt + 1 + Ot - dtLocal.themeSettings.floatingHeader.height ? (Dt = "changing", Lt.css({
                    transition: "none",
                    height: Pt + Ot - t
                })) : t > Pt + 1 + dtLocal.themeSettings.floatingHeader.height && "end" !== Dt ? (Dt = "end", Lt.css({
                    height: dtLocal.themeSettings.floatingHeader.height,
                    transition: "all 0.3s ease"
                })) : t <= Pt + 1 && "start" !== Dt && (Dt = "start", Lt.css({
                    height: Ot,
                    transition: "all 0.1s ease"
                }))
            }
            dtGlobals.resetSizes = function(e) {
                if (window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !s.hasClass("responsive-off")) return Ft || (Ft = !0, E.removeClass("sticky-off sticky-on"), D || Mt.removeClass("sticky-space-off sticky-space-on"), E.css({
                    top: "",
                    transform: ""
                }), At = !1, Dt = "", t(".is-safari").length > 0 && E.css({
                    width: "",
                    "max-width": ""
                })), !1;
                Ft && (Ft = !1), At || "" !== Dt || (E.addClass("sticky-off"), D || Mt.addClass("sticky-space-off")), zt = t("#wpadminbar").exists() ? t("#wpadminbar").height() : 0, J = !I.exists() || I.is(":hidden") || I.hasClass("top-bar-empty") || I.hasClass("hide-top-bar") ? 0 : I.innerHeight(), Et = dtLocal.themeSettings.desktopHeader.height + J, Ot = dtLocal.themeSettings.desktopHeader.height, gt ? gt && !D ? Pt = s.hasClass("floating-top-bar") ? e - J : e : gt && D ? Pt = s.hasClass("floating-top-bar") ? e - Ot - J : e - Ot : Lt.offset().top : Pt = s.hasClass("floating-top-bar") ? 0 : J, D || Mt.css({
                    height: Et
            ...
            }, dtGlobals.resetSizes(P.height()), n.on(" debouncedresize", (function() {
                dtGlobals.resetSizes(P.height())
            })), Ht(), n.on("scroll", (function() {
                Ht()
            }))
        }
        if (O.exists()) {
            var Bt = 0,
                Rt = (zt = 0, J = 0, !1);
            O.addClass("sticky-top-line-off"), t(".top-line-space").exists() || D || t("<div class='top-line-space'></div>").insertBefore(O);
            var Wt;
            It = t(".branding a", O).attr("href"), (Wt = O.find(".branding")).find("img");
            ...
            dtGlobals.resetTopLineSizes = function(e) {
                if (window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !s.hasClass("responsive-off")) return Ft || (Ft = !0, O.removeClass("sticky-top-line-on"), O.css({
                    top: ""
                }), Rt = !1), !1;
                Ft && (Ft = !1), zt = t("#wpadminbar").exists() ? t("#wpadminbar").height() : 0, J = !I.exists() || I.is(":hidden") || I.hasClass("top-bar-empty") || I.hasClass("hide-top-bar") ? 0 : I.innerHeight(), Bt = O.find(".header-bar").height() + J, t(".top-line-space").css({
                    height: Bt
                }), t(".is-safari").length > 0 && (a.hasClass("boxed") ? O.css({
                    width: a.width(),
                    "max-width": a.width()
                }) : O.css({
                    width: document.documentElement.clientWidth,
            ...
            }, dtGlobals.resetTopLineSizes(P.height()), n.on("resize debouncedresize", (function() {
                dtGlobals.resetTopLineSizes(P.height())
            })), n.on("scroll", (function() {
                if (window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !s.hasClass("responsive-off")) return !1;
                var t = dtGlobals.winScrollTop > O.height();
                t && !Rt ? (O.removeClass("sticky-top-line-off").addClass("sticky-top-line-on"), O.hasClass("mixed-floating-top-bar") ? O.css({
                    top: zt
                }) : O.css({
                    top: zt - J
                }), Rt = !0) : !t && Rt && (O.removeClass("sticky-top-line-on").addClass("sticky-top-line-off"), O.css({
                    top: zt
                }), Rt = !1)
            }))
        }
        if (dtLocal.themeSettings.floatingHeader.showMenu && dtLocal.themeSettings.floatingHeader.showMenu && !Tt) {
            var jt = t(".phantom-fade").exists(),
                $t = t(".phantom-slide").exists(),
                Nt = t(".split-header").exists();
            if (jt || $t) {
                var Gt = t(".masthead:not(#phantom) .main-nav").clone(!0).removeAttr("id"),
                    Yt = (It = t(".branding a", L).attr("href"), s.hasClass("floating-top-bar") ? t(".masthead:not(#phantom) .top-bar").clone(!0) : ""),
                    qt = !1;
                if (Nt) {
                    var Ut = L.attr("class"),
                        Vt = t(".side-header-h-stroke, .split-header"),
                        Xt = (je = t('<div id="phantom" class="' + Ut + '"><div class="ph-wrap"></div></div>').appendTo("body")).find(".ph-wrap"),
                        Zt = je.find(".widget-box"),
                        Qt = Gt.find(".mini-widgets"),
                        Kt = Vt.find(".branding");
                    t(".phantom-custom-logo-on").length > 0 && dtLocal.themeSettings.floatingHeader.logo.html && dtLocal.themeSettings.floatingHeader.logo.showLogo && (null == It ? t(dtLocal.themeSettings.floatingHeader.logo.html).prependTo(Kt) : t('<a class="phantom-top-line-logo" href="' + It + '">' + dtLocal.themeSettings.floatingHeader.logo.html + " </a>").prependTo(Kt)), (Gt = t(".split-header .header-bar").clone(!0)).appendTo(Xt).find(".main-nav").removeAttr("id"), s.hasClass("floating-top-bar") && Yt.insertBefore(Xt)
                } else {
                    Ut = L.attr("class"), Xt = (je = t('<div id="phantom" class="' + Ut + '"><div class="ph-wrap"><div class="logo-box"></div><div class="menu-box"></div><div class="widget-box"></div></div></div>').appendTo("body")).find(".menu-box"), Zt = je.find(".widget-box");
                    if (t(".classic-header").length > 0) Qt = t(".header-bar .navigation .mini-widgets").clone(!0);
                    else if (Nt);
                    else Qt = t(".header-bar .mini-widgets").clone(!0);
                    Gt.appendTo(Xt), Qt.appendTo(Zt), s.hasClass("floating-top-bar") && Yt.prependTo(je), dtLocal.themeSettings.floatingHeader.logo.html && dtLocal.themeSettings.floatingHeader.logo.showLogo && (je.find(".ph-wrap").addClass("with-logo"), null == It ? je.find(".logo-box").html('<a href="' + dtLocal.themeSettings.floatingHeader.logo.url + '">' + dtLocal.themeSettings.floatingHeader.logo.html + " </a>") : je.find(".logo-box").html('<a href="' + It + '">' + dtLocal.themeSettings.floatingHeader.logo.html + " </a>"))
                }
                var Jt, te = t("#phantom");
                a.hasClass("boxed") && je.addClass("boxed").find(".ph-wrap").addClass("boxed"), te.removeClass("show-phantom").addClass("hide-phantom").css("visibility", "hidden"), dtGlobals.addOnloadEvent((function() {
                    clearTimeout(Jt), Jt = setTimeout((function() {
                        te.css("visibility", "")
                    }), 150)
                })), Xt.find(".is-loading").removeClass("is-loading"), Xt.layzrInitialisation();
                var ee = !1,
                    ie = dtGlobals.winScrollTop;
                Ct = P.height(), L.height();
                if (gt && D);
                else if (gt);
                ...
                n.on("scroll", (function() {
                    ...
                    var t = dtGlobals.winScrollTop,
                        e = P.height(),
                        i = L.height();
                    if (gt && D) var n = t > e && !1 === qt,
                        a = t <= e && !0 === qt;
                    else if (gt) n = t > e + i && !1 === qt, a = t <= e + i && !0 === qt;
                    else n = t > dtLocal.themeSettings.floatingHeader.showAfter && !1 === qt, a = t <= dtLocal.themeSettings.floatingHeader.showAfter && !0 === qt;
                    n ? o.hasClass("menu-open") || dtGlobals.isHovering || ee || (ee = !0, te.removeClass("hide-phantom").addClass("show-phantom"), qt = !0) : a && ee && (o.hasClass("menu-open") || (ee = !1, te.removeClass("show-phantom").addClass("hide-phantom"), qt = !1))
                }))
            }
        }
        var ne = t(".side-header:not(.sub-sideways ) .main-nav li.has-children > a:not(.not-clickable-item), .side-header:not(.sub-sideways ) .level-arrows-on > li.has-children > a, .mobile-main-nav li.has-children > a");
        t('<i class="next-level-button"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16" style="enable-background:new 0 0 16 16;" xml:space="preserve"><path d="M13.5,7H9V2.5c0-0.6-0.4-1-1-1s-1,0.4-1,1V7H2.5c-0.6,0-1,0.4-1,1s0.4,1,1,1H7v4.5c0,0.6,0.4,1,1,1s1-0.4,1-1V9h4.5c0.6,0,1-0.4,1-1S14.1,7,13.5,7z"/></svg></i>').insertAfter(ne), t(".sub-downwards .main-nav li.has-children, .mobile-main-nav li.has-children").each((function() {
            var e = t(this),
            ...
            e.find(".sub-nav li, .sub-menu li").hasClass("act") && e.addClass("active"), e.find(".sub-nav li.act, .sub-menu li.act").hasClass("act") && (e.addClass("open-sub"), i.stop(!0, !0).slideDown(100), i.layzrInitialisation()), e.find(" > .next-level-button").on("click", (function(e) {
                ...
                })), n.removeClass("active"), n.removeClass("open-sub"), n.find("a").removeClass("act")) : (n.siblings().find(" .sub-nav, .dt-mega-menu-wrap, .sub-menu").stop(!0, !0).slideUp(400), i.stop(!0, !0).slideDown(500, (function() {
                    n.find(".sub-nav, .sub-menu").layzrInitialisation()
                })), n.siblings().removeClass("active"), n.addClass("active"), n.siblings().removeClass("open-sub"), n.addClass("open-sub"), n.siblings().find("> a").removeClass("act"), n.find("a").addClass("act"), t(" .main-nav").layzrInitialisation())
            }))
        })), !t(".dt-parent-menu-clickable").length > 0 && t(".sub-downwards .main-nav li > a, .mobile-main-nav li.has-children > a").each((function() {
            var e = t(this);
            e.parent("li").find(".sub-nav li, .sub-menu li").hasClass("act") && e.addClass("act"), e.parent("li").find(".sub-nav li.act, .sub-menu li.act").hasClass("act") && (e.parent("li").addClass("open-sub"), e.siblings(".sub-nav, .sub-menu").stop(!0, !0).slideDown(100, (function() {}))), e.on("click", (function(i) {
        ...
        t.fn.hoverdir = function(e) {
                ...
                if ("string" == typeof e) {
                    ...
                    this.each((function() {
                        i ? the7Utils.isFunction(i[e]) && "_" !== e.charAt(0) ? i[e].apply(i, n) : oe("no such method '" + e + "' for hoverdir instance") : oe("cannot call methods on hoverdir prior to initialization; attempted to call method '" + e + "'")
                    }))
        ...
        se.on("click", "a.clear-form", (function(t) {
            return t.preventDefault(), se.find('input[type="text"], textarea').val(""), !1
            ...
            ae()
        })), ae())), n.trigger("dt.removeLoading");
        var re = t("#main-slideshow");
        !re.find("> div").length > 0 && re.addClass("empty-slider"),
            /*!-Revolution slider*/
        ...
        if (de.length > 0 && (s.on("click", (function(e) {
            ...
            he.append(ce), t(".overlay-search").hasClass("default-icon") && he.addClass("default-icon"), t(".mini-search .submit").on("click", (function(e) {
                e.preventDefault(), he.addClass("open"), t("#page").addClass("overlay-open")
        ...
        const ue = t('.wpb_tabs_nav [role="tab"]');
        let pe = ue.index(ue.filter('[aria-selected="true"]'));

        function fe(e) {
            ue.attr({
                "aria-selected": "false",
                tabindex: "-1"
            }).removeClass("ui-tabs-active ui-state-active"), t(".wpb_tab").attr("aria-hidden", "true").hide(), e.attr({
                "aria-selected": "true",
                tabindex: "0"
            }).addClass("ui-tabs-active ui-state-active"), t("#" + e.attr("aria-controls")).attr("aria-hidden", "false").show(), pe = ue.index(e)
        }
        var me, ge;
        /*!-Show share buttons*/
        ue.attr("tabindex", "0"), ue.on("focus", (function() {
                pe = ue.index(this)
            })), ue.on("keydown", (function(t) {
                switch (t.key) {
                    case "ArrowRight":
                        t.preventDefault(), pe = (pe + 1) % ue.length, ue.eq(pe).focus();
                        break;
                    case "ArrowLeft":
                        t.preventDefault(), pe = (pe - 1 + ue.length) % ue.length, ue.eq(pe).focus();
                        break;
                    case "Enter":
                    case " ":
                        t.preventDefault(), fe(ue.eq(pe))
                }
            })), ue.on("click", (function(e) {
                e.preventDefault(), fe(t(this))
            ...
            t(".widget .searchform .submit, .search-icon, form.searchform:not(.mini-widget-searchform) .submit").on("click", (function(e) {
            ...
            }, dtGlobals.isMobile && t(".skills").animateSkills(), t(".project-share-overlay.allways-visible-icons .share-button").on("click", (function(t) {
                t.preventDefault()
            })), dtGlobals.addOnloadEvent((function() {
                t(".album-share-overlay, .project-share-overlay:not(.allways-visible-icons)").each((function() {
                    ...
                    e.find(".share-button").on("click", (function(t) {
                        ...
                        "tap" == e.type && e.stopPropagation();
                        var i = t(this);
                        i.addClass("dt-hovered"), clearTimeout(me), clearTimeout(ge), me = setTimeout((function() {
                        ...
                        var i = t(this);
                        i.removeClass("dt-hovered"), clearTimeout(me), clearTimeout(ge), ge = setTimeout((function() {
        ...
        be.on("click", (function() {
            ...
            n.on("debouncedresize", (function() {
                ...
                return t.preventDefault(), Ve("up"), !1
            }));
        var Ce = t(".woocommerce-NoticeGroup-updateOrderReview, .woocommerce-NoticeGroup-checkout");
        !Ce.length && t("form.checkout").exists() && (Ce = t("form.checkout").parents(".content").offset().top), t(document.body).on("checkout_error", (function() {
                t("html, body").animate({
                    scrollTop: Ce - je.height()
                }, "slow")
            })),
            /*!-Custom select*/
        ...
        var _e = navigator.userAgent.match(/iPhone/i) ? "touchstart" : "click";
        if (t(".project-navigation a, .mobile-sticky-header-overlay").bind(_e, (function(t) {})), t((function() {
            ...
            t("#fancy-header .fancy-title:not(.start-animation), #fancy-header .fancy-subtitle:not(.start-animation), #fancy-header .breadcrumbs:not(.start-animation)").each((function() {
                var e = t(this);
                e.hasClass("start-animation") || e.hasClass("start-animation-done") || (e.addClass("start-animation-done"), xe++, setTimeout((function() {
        ...
        if (jQuery(".wpcf7").each((function() {
            ...
            if (At) var Se = t(".sticky-on");
            else Se = t(".masthead:not(.side-header):not(.side-header-v-stroke) .header-bar");
            if (J = !I.exists() || I.is(":hidden") || I.hasClass("top-bar-empty") || I.hasClass("hide-top-bar") ? 0 : I.innerHeight(), jt || $t) var ke = t(je).height() + 20;
            else if (dtLocal.themeSettings.floatingHeader.showMenu && Tt)
                if (s.hasClass("floating-top-bar")) ke = dtLocal.themeSettings.floatingHeader.height + J + 20;
                else ke = dtLocal.themeSettings.floatingHeader.height + 20;
            else if (O.exists()) ke = O.find(".header-bar").height() + J + 20;
            else ke = 0;
        ...
        t("#mphb-booking-details").find(".mphb-booking-details-title, .mphb-check-in-date, .mphb-check-out-date").wrapAll('<div class="mphb-details-sidebar"></div>'), t("#mphb-price-details").appendTo(".mphb-details-sidebar"), !t(".footer .widget").length > 0 && t(".footer").addClass("empty-footer"), dtGlobals.addOnloadEvent((function() {
            t(".the7-elementor-widget:not(.the7-elementor-product-comments)").each((function() {
                var e = t(this),
                    i = e.find(".stars a");
                i.length ? (i.length > 5 && (i.slice(5, i.length).remove(), i = e.find(".stars a")), e.find(".stars span").append(i.get().reverse())) : (e.find("#rating").hide().before('<p class="stars">                            <span>                                <a class="star-5" href="#">5</a>                                <a class="star-4" href="#">4</a>                                <a class="star-3" href="#">3</a>                                <a class="star-2" href="#">2</a>                                <a class="star-1" href="#">1</a>                            </span>                        </p>'), i = e.find(".stars a")), i.each((function() {
                    const e = t(this),
                        i = e.attr("class"),
                        n = i ? i.match(/star-(\d+)/)[1] : "";
                    e.data("star-value", n)
                })), i.on("click", (function() {
                    var e = t(this),
                        i = t(this).closest("#respond").find("#rating"),
                        n = t(this).closest(".stars");
                    return i.val(e.data("star-value")), e.siblings("a").removeClass("active"), e.addClass("active"), n.addClass("selected"), !1
                }))
                ...
                e.parents().hasClass("hide-tab-description") && !e.parents().hasClass("hide-tab-additional") ? t("#tab-title-additional_information.dt-tab-accordion-title").addClass("first") : e.parents().hasClass("hide-tab-additional") && !e.parents().hasClass("hide-tab-description") || e.parents().hasClass("hide-tab-additional") && e.parents().hasClass("hide-tab-description") ? t("#tab-title-reviews.dt-tab-accordion-title").addClass("first") : t("#tab-title-description.dt-tab-accordion-title").addClass("first"), t(".dt-tab-accordion-title.first").next().css("display", "block"), e.on("click", (function(e) {
                    var i = t(this),
                        n = i.next();
                    t(".dt-tab-accordion-title").removeClass("active"), i.hasClass("active") ? t(".woocommerce-Tabs-panel").slideUp("fast") : (i.addClass("active"), t(".woocommerce-Tabs-panel").not(n).hide(), Ue(i.parent()), n.slideDown("fast"))
                }))
        ...
        var Te = t(".elementor-popup-modal .dialog-message");
        i.on("elementor/popup/show", Te, (function(e, i, n) {
            ...
            return this.each((function() {
                ...
                if (h = b ? " \t\t\t\t\t\t\t.cont-id-" + f + " { margin: -" + y + "px  -" + g + "px -" + w + "px ; } \t\t\t\t\t\t\t.full-width-wrap .cont-id-" + f + " { margin: " + -y + "px " + g + "px " + -w + "px ; }" : " \t\t\t\t\t\t\t.cont-id-" + f + " { margin: -" + g + "px; } \t\t\t\t\t\t\t.full-width-wrap .cont-id-" + f + " { margin: " + v + "px  " + g + "px; } \t\t\t\t\t\t", _.html(h), p.hasClass("resize-by-browser-width")) void 0 === d && (d = the7GetMasonryColumnsConfig), a = (o = d.call(this, u)).singleWidth, r = o.doubleWidth, c = o.columnsNum;
                else {
        ...
        var Ie = Isotope.prototype._positionItem;
        ...
        Isotope.prototype._positionItem = function(t, e, i, n) {
            ...
            return Le(this, t, "img[class*=iso-]", "iso-item-lazy-load")
        }, t.fn.IsoLayzrJqInitialisation = function(t) {
            return Le(this, t, "img", "thumb-lazy-load-show")
        }, t.fn.layzrBlogInitialisation = function(t) {
            return Le(this, t, "img", "blog-thumb-lazy-load-show")
        }, t(".layzr-loading-on .blog-shortcode.jquery-filter.mode-list .visible").layzrBlogInitialisation();
        var ze = t(".iso-container"),
            Ee = t(".iso-grid:not(.jg-container, .iso-container), .blog.layout-grid .wf-container.description-under-image:not(.jg-container, .iso-container), .grid-masonry:not(.iso-container), .shortcode-blog-posts.iso-grid"),
            Oe = ze.add(Ee),
            Pe = dtGlobals.isoPreloader = t('<div class="iso-preloader dt-posts-preload dt-posts-preload-active"><div class="dt-posts-preload-activity"></div></div>').appendTo("body").hide();
        Oe.not(".blog-grid-shortcode").addClass("dt-isotope"), window.the7ApplyColumns = function(t, e, i) {
                var o, s;
            ...
            }, Oe.exists() && Oe.not(".custom-iso-columns").each((function(e) {
            ...
            })), t(".dt-css-grid .wf-cell.visible").IsoLayzrJqInitialisation(), (ze.exists() || Ee.exists()) && (Pe.fadeIn(50), Oe.not(".blog-grid-shortcode").each((function() {
                var e = t(this),
                    i = e;
            ...
            , window.the7ApplyGeneralFilterHandlers = function(e) {
                e.exists() && e.find("> a").on("click", (function(e) {
                    ...
                    e.preventDefault(), i.trigger("mouseleave"), i.hasClass("act") ? e.stopImmediatePropagation() : (i.siblings().removeClass("act"), i.addClass("act"), arguments.callee.dtPreventD || (window.location.href = i.attr("href")))
                }))
                ...
                i.Filterade(e), i.on("updateReady", (function() {
                    di(), i.parent(".content-rollover-layout-list:not(.disable-layout-hover)").find(".post-entry-wrapper").clickOverlayGradient()
                })), n.on("scroll", (function() {
                    o()
                })), o()
        ...
        var Ae = t(".content-rollover-layout-list:not(.disable-layout-hover) .dt-css-grid .post-entry-wrapper");
        ...
        n.on("debouncedresize", (function(e) {
            if (dtGlobals.resizeCounter++, the7Utils.isFunction(t.fn.calcPics) && t(".instagram-photos").calcPics(), a.hasClass("boxed")) {
                var i = a.css("maxWidth"),
                    r = i.indexOf("px") >= 0,
                    l = i.indexOf("%") >= 0;
                r && (L.addClass("width-in-pixel"), void 0 !== je && je.addClass("width-in-pixel")), l && (t(".masthead.full-width:not(.side-header)").css({
                    width: a.width()
                }), void 0 !== je && je.find(".top-bar-bg").length > 0 && je.find(".top-bar-bg").css({
                    width: a.width()
            ...
            Ae.clickOverlayGradient(), window.innerWidth >= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && (a.removeClass("show-mobile-header"), a.addClass("closed-mobile-header"), s.removeClass("show-sticky-mobile-header"), s.removeClass("show-overlay-mobile-header").addClass("closed-overlay-mobile-header"), t(".mobile-sticky-header-overlay").removeClass("active"), t(".dt-mobile-menu-icon").removeClass("active"), o.removeClass("menu-open")), window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !s.hasClass("responsive-off") ? (t(".masthead").hasClass("masthead-mobile") || t(".masthead:not(.mixed-header):not(#phantom)").addClass("masthead-mobile"), t(".masthead").hasClass("masthead-mobile-header") || (t(".masthead:not(.side-header):not(#phantom)").addClass("masthead-mobile-header"), t("body:not(.overlay-navigation):not(.sticky-header) .side-header:not(#phantom)").addClass("masthead-mobile-header")), O.exists() && (O.removeClass("sticky-top-line-on sticky-top-line-on"), Rt = !1), t(".mobile-header-scrollbar-wrap").css({
                ...
                var e = d.siblings(".project-wide-col").height(),
                    ...
                    o = d.offset(),
                    s = 0;
                I.length > 0 && t(".phantom-sticky").length > 0 && (s = I.height());
                var a = t(".project-post").offset();
                n.on("scroll", (function() {
                    var t = "0";
                    window.innerWidth > 1050 && dtGlobals.winScrollTop + je.height() > o.top && (t = dtGlobals.winScrollTop + je.height() + i + 40 < a.top + e ? dtGlobals.winScrollTop - o.top + je.height() + 5 - s + "px)" : e - i - 40 - s + "px)"), d.css({
        ...
        })).trigger("debouncedresize"), t(window).trigger("the7_widget_resize"), De(), n.on("the7-resize-height-debounce", De), window.addEventListener("orientationchange", De);
        var Me = t("html, body"),
            Fe = t(".phantom-sticky"),
            He = t(".sticky-top-line"),
            Be = (Tt = Fe.exists(), He.exists()),
            Re = t(".sticky-mobile-header").exists(),
            We = Tt || Be,
            je = null,
            $e = (Se = null, t('.menu-item > a[href="#!/up"]'));

        function Ne() {
            window.innerWidth < dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !s.hasClass("responsive-off") ? Re && (je = t(".masthead-mobile-header")) : je = We ? t(".masthead") : Re && !t(".mobile-false").length > 0 ? t(".masthead-mobile-header") : t("#phantom");
            var e = t(".mobile-header-bar");
            e.length > 0 && "none" !== e.css("display") ? (Se = e, Be && (Se = t(".sticky-top-line.masthead-mobile-header .mobile-header-bar")), (Tt || Be) && (je = t(".sticky-header .masthead.side-header").length > 0 || t(".overlay-navigation .masthead.side-header").length > 0 ? e.parent(".masthead:not(.side-header)") : e.parent())) : (Se = t(".masthead:not(.side-header):not(.side-header-v-stroke)"), s.hasClass("floating-top-bar") || (Se = Se.find(".header-bar")))
        }
        Ne();
        var Ge = function(t, e, i, n) {
                void 0 === n && (n = "easeInOutQuad"), Me.stop().animate({
                    scrollTop: t
                }, {
                    duration: e,
                    easing: n,
        ...
        window.the7ScrollToTargetEl = Ue;
        var Ve = function(e, i, n) {
                if (!e) return !1;
                try {
                    var o = t("#" + e),
                        s = !1
        ...
        dtGlobals.addOnloadEvent((function() {
            ...
            window.clickAnchorLink = function(e) {
                const i = e.attr("href"),
                    n = Xe(i),
                    o = Ve(n, i, e);
                if (o && t(window).trigger("the7.anchorScrolling", [n, i, e]), e.closest(".elementor-popup-modal").length) {
                    let t = e.closest(".elementor-location-popup");
                    const i = t.data("elementor-id");
                    if (i) {
                        let e = !0;
                        const n = t.data("elementor-settings") || {};
                        "yes" === n.prevent_close_on_background_click && "yes" === n.prevent_close_on_esc_key && (e = !1), e && elementorFrontend.documentsManager.documents[i].getModal().hide()
                    }
                }
                return t(".menu-item a").parent("li").removeClass("act"), t(".dt-nav-menu a").removeClass("active-item"), e.parents("li.menu-item ").addClass("act"), e.parent().parent().hasClass("dt-nav-menu") && e.addClass("active-item"), o
        ...
        const Qe = '.menu-item > a[href*="#"]';

        function Ke() {
            var e = window.location.hash,
                i = Xe(e);
            if (!i) return $e.length > 0 && $e.parent("li").addClass("act"), !1;
            t(".menu-item a").parent("li").removeClass("act"), t(".dt-nav-menu a").removeClass("active-item");
            var n = t(".menu-item a[href='" + e + "']"),
                o = t(".dt-nav-menu > li a[href='" + e + "']"),
                s = t(".dt-nav-menu .the7-e-sub-nav a[href='" + e + "']");
            n.parent("li").addClass("act"), o.addClass("active-item"), s.addClass("active-item"), t(".menu-item a[href*='" + e + "']").parent("li").addClass("act"), t(".dt-nav-menu a[href*='" + e + "']").addClass("active-item");
            var a = n.parents("li");
            if (a.find(".sub-nav li.act, .sub-menu li.act, .vertical-sub-nav li.act").length) {
                var r = a.find(" > .sub-nav, .sub-menu, .vertical-sub-nav");
                a.addClass("open-sub"), r.stop(!0, !0).slideDown(100)
            }
            return i
        }
        Ze(t(Qe)), i.on("elementor/popup/show", t(".elementor-popup-modal .dialog-message"), (function(e, i, n) {
            var o = n.$element.find(Qe);
            Ze(o), o.on("click", (function(e) {
                if (!t(e.target).parent().hasClass("next-level-button") && clickAnchorLink(t(this))) return e.preventDefault(), !1
            }))
        })), i.on("elementor/popup/show", (function(t, e, i) {
            Ke() && elementorFrontend.elements.$window.one("the7.anchorScrolling.elementorPopup", (function() {
                i.getModal() && i.getModal().hide()
            }))
        })), i.on("elementor/popup/hide", (function() {
            elementorFrontend.elements.$window.off("the7.anchorScrolling.elementorPopup")
        }));
        var Je = t(".one-page-row div[data-anchor^='#']"),
            ti = t(".one-page-row .vc_row[id], .one-page-row .vc_section[id], .elementor-element[id], .elementor-menu-anchor[id]"),
            ei = t.merge(Je, ti),
            ii = null;

        function ni(e) {
            const i = t('.menu-item a[href*="#"]'),
                n = t('.dt-nav-menu a[href*="#"]');
            if (i.parents("li").removeClass("act"), n.removeClass("active-item"), e) {
                let t = "";
                t = e === ri ? `[href="${ri}"]` : `[href*="#!/${e}"],[href*="#${e}"]`, i.filter(t).parents("li").addClass("act"), n.filter(t).addClass("active-item")
            }
        }
        ...
        Je.length > 0 ? ii = Je.first() : ti.length > 0 && (ii = ti.first()), Je = null, ti = null;
        var si = null,
            ai = s.hasClass("is-scroll");
        const ri = "#!/up";
        ...
        function li() {
            ...
            ei.each((function() {
                let n = t(this);
                n.hasClass("wpb_animate_when_almost_visible") && n.one("webkitAnimationEnd oanimationend msAnimationEnd animationend", (function(t) {
                    ni(oi(n, e))
                }));
                let o = oi(n, e);
                o && (i = o)
            })), $e.length > 0 && null !== ii && dtGlobals.winScrollTop < ii.offset().top - e && (i = ri), i !== si && (si = i, ni(i))
        }
        /*!-set active menu item on scroll*/
        function di() {
            var e = t(".dt-isotope"),
        ...
        var ci = {
            ...
            launch: function(e) {
                ...
                "action" in this.settings && (o = this.settings.action), this.xhr = t.post(e.ajaxurl, {
                    ...
                    void 0 !== e.afterResponce && e.afterResponce(o), di()
                }))
            },
            init: function() {
        ...
        t("#content").on("click", ".paginator.with-ajax a", (function(e) {
            ...
            n.resetEffects(), a && dtGlobals.isoPreloader.fadeIn(50), ci.launch(t.extend({}, s, {
        ...
        var pi, fi = (pi = {}, function(t, e, i) {
            i || (i = "Don't call this twice without a uniqueId"), pi[i] && clearTimeout(pi[i]), pi[i] = setTimeout(t, e)
        });
        n.on("the7-resize-width", (function() {
            var e = t(".iso-item, .iso-grid .wf-cell");
            e.addClass("animate-position"), fi((function() {
                e.removeClass("animate-position")
            }), 2500, "")
        }));
        var mi = t(".dt-isotope"),
            gi = t(".iso-item:not(.shown):not(.is-visible)"),
            vi = t(".iso-grid .wf-cell:not(.shown):not(.is-visible), .dt-css-grid .wf-cell:not(.shown):not(.is-visible)");
        (mi.exists() || gi.exists() || vi.exists()) && (setTimeout((function() {
            di()
        ...
        var wi = function() {
            ...
            yi = function() {
                ...
                return e.prototype = new wi, e.prototype.addEvents = function() {
                    var e = this;
            ...
            bi = function() {
                function e(t) {
                    wi.call(this, t), this.appendControls(), this.addEvents(), this.layoutItems(), this.applyLoadingEffects()
                }
                return e.prototype = new wi, e.prototype.addEvents = function() {
            ...
            _i = function() {
                ...
                return e.prototype = new Ci, e.prototype.getFilteredItems = function() {
        ...
        ! function() {
            function e(t) {
                Ci.call(this, t), this.items = this.config.postsContainer.find(".wf-cell"), this.filteredItems = this.items
            }
            e.prototype = new Ci, e.prototype.getFilteredItems = function() {
                return this.filteredItems
            }, e.prototype.getItems = function() {
                return this.items
        ...
        t(".dt-shortcode.with-isotope").each((function() {
            ...
            if (n) {
                ...
                a || (a = e.find(".filter-categories").attr("data-default-orderby")), t.extend(o, {
                    ...
                    onCategoryFilter: function(e) {
                        ...
                        var i = t(this),
                            n = e.data.self;
                        n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setCurCategory(i.attr("data-filter")), n._filterPosts(), l.hideItem(n.getItems()), l.reset(n.getFilteredItems()), n.layout(), n.config.postsContainer.IsoLayzrInitialisation(), ui(), di()
                    },
                    onOrderFilter: function(e) {
                        e.preventDefault();
                        var i = t(this),
                            n = e.data.self;
                        n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setOrder(i.attr("data-sort")), n._filterPosts(), l.hideItem(n.getItems()), l.reset(n.getFilteredItems()), n.layout(), n.config.postsContainer.IsoLayzrInitialisation(), ui(), di()
                    },
                    onOrderByFilter: function(e) {
                        e.preventDefault();
                        var i = t(this),
                            n = e.data.self;
                        n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setOrderBy(i.attr("data-by")), n._filterPosts(), l.hideItem(n.getItems()), l.reset(n.getFilteredItems()), n.layout(), n.config.postsContainer.IsoLayzrInitialisation(), ui(), di()
                    }
                });
                var r = new Ci(o),
                    l = new yi({
                ...
                r.config.onCategoryFilter = function(e) {
                    ...
                    var i = t(this),
                        n = e.data.self;
                    n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setCurCategory(i.attr("data-filter")), n._filterPosts(), l.hideItem(n.getItems()), l.reset(n.getFilteredItems()), n.layout(), ui(), di()
            ...
            var l = {
                    ...
                    onCategoryFilter: function(e) {
                        ...
                        var i = t(this),
                            n = e.data.self;
                        n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setCurCategory(i.attr("data-filter")), n._filterPosts(), c.hideItem(n.getItems()), c.reset(n.getFilteredItems()), n.layoutItems(), n.config.postsContainer.IsoLayzrInitialisation(), g(), di()
                    },
                    onOrderFilter: function(e) {
                        e.preventDefault();
                        var i = t(this),
                            n = e.data.self;
                        n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setOrder(i.attr("data-sort")), n._filterPosts(), c.hideItem(n.getItems()), c.reset(n.getFilteredItems()), n.layoutItems(), n.config.postsContainer.IsoLayzrInitialisation(), g(), di()
                    },
                    onOrderByFilter: function(e) {
                        e.preventDefault();
                        var i = t(this),
                            n = e.data.self;
                        n.config.postsContainer.resetEffects(), n._setAsActive(i), n.setOrderBy(i.attr("data-by")), n._filterPosts(), c.hideItem(n.getItems()), c.reset(n.getFilteredItems()), n.layoutItems(), n.config.postsContainer.IsoLayzrInitialisation(), g(), di()
                    }
                },
                d = new Ci(l);
